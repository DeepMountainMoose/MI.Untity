...
namespace DapperWrapper
{
    public class SqlExecutor : IDbExecutor
    {
        ...
        public IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TReturn>(string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map,
            object param,
            TransactionScopeOption transactionScopeOption, string splitOn = "Id")
        {
            try
        ...
        public IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TReturn> map,
            object param,
            TransactionScopeOption transactionScopeOption, string splitOn = "Id")
        {
            try
        ...
        public IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn>(string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn> map,
            object param,
            TransactionScopeOption transactionScopeOption, string splitOn = "Id")
        {
            try
        ...
        public T QuerySingle<T>(string sql, object param, TransactionScopeOption transactionScopeOption)
        {
            try
            {
                using (new TransactionScope(transactionScopeOption))
        ...
        public dynamic QuerySingle(string sql, object param, TransactionScopeOption transactionScopeOption)
        {
            try
            {
                using (new TransactionScope(transactionScopeOption))
        ...
        public T QuerySingleOrDefault<T>(string sql, object param, TransactionScopeOption transactionScopeOption)
        {
            try
            {
                using (new TransactionScope(transactionScopeOption))
        ...
        public dynamic QuerySingleOrDefault(string sql, object param, TransactionScopeOption transactionScopeOption)
        {
            try
            {
                using (new TransactionScope(transactionScopeOption))
        ...
        public T QueryFirst<T>(string sql, object param, TransactionScopeOption transactionScopeOption)
        {
            try
            {
                using (new TransactionScope(transactionScopeOption))
        ...
        public T QueryFirstOrDefault<T>(string sql, object param, TransactionScopeOption transactionScopeOption)
        {
            try
            {
                using (new TransactionScope(transactionScopeOption))
        ...
        public T QueryMultiple<T>(string sql, object parameters, Func<SqlMapper.GridReader, T> map, TransactionScopeOption transactionScopeOption)
        {
            try
            {
                using (new TransactionScope(transactionScopeOption))
           ...
           IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            ...
            {
                _dbConnection.Open();
                return await _dbConnection.QuerySingleAsync<T>(
                    sql,
                    param,
                    transaction,
                    commandTimeout,
           ...
           IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            ...
            {
                _dbConnection.Open();
                return await _dbConnection.QueryFirstAsync<T>(
                    sql,
                    param,
                    transaction,
                    commandTimeout,
        ...
        public async Task<T> QueryMultipleAsync<T>(string sql, object param, Func<SqlMapper.GridReader, T> map)
        {
            try
            {
                _dbConnection.Open();
                using (var queryResult = await _dbConnection.QueryMultipleAsync(sql, param).ConfigureAwait(false))
                {
